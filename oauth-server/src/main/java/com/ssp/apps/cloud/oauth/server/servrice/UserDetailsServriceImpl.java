package com.ssp.apps.cloud.oauth.server.servrice;
...
import com.ssp.apps.cloud.oauth.server.entity.UserPrincipal;
import com.ssp.apps.cloud.oauth.server.repository.UserRepository;
